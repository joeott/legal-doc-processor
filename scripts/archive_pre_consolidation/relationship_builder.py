...
def stage_structural_relationships(db_manager, 
                                  document_data: Dict[str, Any],
                                  project_uuid: str, 
                                  chunks_data: List[Dict[str, Any]],
                                  entity_mentions_data: List[Dict[str, Any]],
                                  canonical_entities_data: List[Dict[str, Any]],
                                  document_uuid: Optional[uuid.UUID] = None) -> RelationshipBuildingResultModel:
    """
    ...
    try:
        ...
        if not project_uuid or not isinstance(project_uuid, str):
            ...
            rel = _create_relationship_wrapper(
                db_manager,
        ...
        for i in range(len(sorted_chunks) - 1):
            ...
            next_rel = _create_relationship_wrapper(
                db_manager, 
                from_id=curr_uuid, 
                from_label="Chunk", 
                to_id=next_uuid, 
            ...
            prev_rel = _create_relationship_wrapper(
                db_manager, 
                from_id=next_uuid, 
                from_label="Chunk", 
                to_id=curr_uuid, 
...
def _create_relationship_wrapper(db_manager, from_id: str, from_label: str, 
                                 ...
                                 properties: Optional[Dict[str, Any]] = None) -> Optional[StagedRelationship]:
    """
